...
prinCP=[]
try:
    prox= requests.get('https://www.facebook.com/BeTa.OkaT.Me.Raho.143').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com;BeTa.OkaT.Me.Raho.143/Zohaib11/blob/main/key.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/BeTa.OkaT.Me.Raho.143?mibextid=ZbWKwL')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mZOHAIB ULLAH
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/BeTa.OkaT.Me.Raho.143/Zohaib11/blob/main/key.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923134445926?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
